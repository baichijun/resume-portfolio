...
SetVariables({
  ...
  "bg-secondary": { type: "color", value: "#111111" },
  "text-primary": { type: "color", value: "#FFFFFF" },
  "text-muted": { type: "color", value: "#A3A3A3" },
  accent: { type: "color", value: "#8B5CF6" },
  "accent-secondary": { type: "color", value: "#06B6D4" },
  border: { type: "color", value: "#FFFFFF1A" },
  "card-bg": { type: "color", value: "#FFFFFF0A" },
  "card-hover": { type: "color", value: "#FFFFFF14" },
  "radius-md": { type: "number", value: 16 },
  shadow: { type: "string", value: "0 0 40px rgba(139, 92, 246, 0.15)" },
  "font-display": { type: "string", value: "Syne" },
  "font-body": { type: "string", value: "DM Sans" }
}, true)
headerComp=Insert(document,{type:"frame",name:"Component/Header",x:-2000,y:0,reusable:true,layout:"horizontal",width:1152,height:61,alignItems:"center",justifyContent:"space_between",padding:[0,24],fill:"#0A0A0A99",stroke:"$border",strokeWidth:{bottom:1}})
...
headerMobile=Insert(document,{type:"frame",name:"Component/HeaderMobile",x:-2000,y:100,reusable:true,layout:"horizontal",width:390,height:61,alignItems:"center",justifyContent:"space_between",padding:[0,16],fill:"#0A0A0ACC",stroke:"$border",strokeWidth:{bottom:1}})
...
glassCard=Insert(document,{type:"frame",name:"Component/GlassCard",x:-2000,y:480,reusable:true,layout:"vertical",width:400,gap:16,padding:24,fill:"$card-bg",stroke:"$border",strokeWidth:1,cornerRadius:"$radius-md"})
Insert(glassCard,{type:"text",name:"Card Placeholder",fontFamily:"$font-body",fontSize:14,fill:"$text-muted",content:"卡片内容区"})
projectCard=Insert(document,{type:"frame",name:"Component/ProjectCard",x:-2000,y:640,reusable:true,layout:"vertical",width:360,gap:12,padding:24,fill:"$card-bg",stroke:"$border",strokeWidth:1,cornerRadius:"$radius-md"})
...
contactCard=Insert(document,{type:"frame",name:"Component/ContactCard",x:-2000,y:820,reusable:true,layout:"vertical",width:260,gap:8,padding:24,fill:"$card-bg",stroke:"$border",strokeWidth:1,cornerRadius:"$radius-md",alignItems:"center"})
...
Insert(btnPrimary,{type:"text",name:"Label",fontFamily:"$font-body",fontSize:14,fontWeight:"600",fill:"#FFFFFF",content:"主要按钮"})
...
themeSwitcher=Insert(document,{type:"frame",name:"Component/ThemeSwitcher",x:-2000,y:1220,reusable:true,layout:"horizontal",gap:8,padding:8,fill:"$card-bg",stroke:"$border",strokeWidth:1,cornerRadius:"$radius-md"})
...
Insert(desktop,{type:"ref",ref:sectionTitle,name:"Contact Title"})
Insert(desktop,{type:"ref",ref:contactCard,name:"Contact Email"})
